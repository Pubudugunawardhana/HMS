...
<body class="bg-light">
          ...
          <form id="info-form">
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb-3">
                ...
                <input name="province" type="text" value="<?php echo $u_fetch['province'] ?>" class="form-control shadow-none" required>
              </div>
               <div class="col-md-4 mb-3">
      ...
      <div class="col-md-4 mb-5 px-4">
        <div class="bg-white p-3 p-md-4 rounded shadow-sm">
          <form id="profile-form">
            ...
            <img src="<?php echo USERS_IMG_PATH.$u_fetch['profile'] ?>" class="rounded-circle img-fluid mb-3" style="width: 300px; height: 300px; object-fit: cover;" alt="Profile Picture">
  ...
  <script>
    ...
    info_form.addEventListener('submit',function(e){
      ...
      data.append('province',info_form.elements['province'].value);
