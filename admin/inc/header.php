<div class="container-fluid bg-dark text-light p-3 d-flex align-items-center justify-content-between sticky-top">
    <h3 class="mb-0 h-font">Heritance 360</h3>
        ...
        <div class="container-fluid flex-lg-column align-items-stretch">
            ...
            <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="adminDropdown">
                <ul class="nav nav-pills flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="equipment.php">Hotel Equipment</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <button
                            class="btn text-white px-3 w-100 shadow-none text-start d-flex align-items-center justify-content-between"
                            type="button" data-bs-toggle="collapse" data-bs-target="#weddingLinks">
                            <span>Wedding Halls</span>
                            <span><i class="bi bi-caret-down-fill"></i></span>
                        </button>
                        <div class="collapse show px-3 small mb-1" id="weddingLinks">
                            <ul class="nav nav-pills flex-column rounded border border-secondary">
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="wedding_halls.php">Manage Halls</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="wedding_inquiries.php">View Inquiries</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item mt-2">
                        <a class="nav-link text-white" href="dine_in.php">Dine-In</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="experience.php">Experience</a>
                    </li>
                </ul>
            </div>
        </div>
